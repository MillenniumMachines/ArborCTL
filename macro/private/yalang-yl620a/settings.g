...
set global.yl620aConfigParams[1] = { {0x0000, { param.F * 10, } } }
...
set global.yl620aConfigParams[3] = { {0x0007, { ceil(var.minFreq + (var.maxFreq - var.minFreq) * 0.02), } } }

; P00 09 - Min Frequency Output
set global.yl620aConfigParams[4] = { {0x0009, { var.minFreq, } } }
...
set global.yl620aConfigParams[5] = { {0x0001, { 3, } } }
set global.yl620aConfigParams[6] = { {0x0304, { 2000, } } }
