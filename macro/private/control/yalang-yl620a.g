...
if { global.arborState[param.S][0] == null }
    ...
    M261.9 E0 P{param.C} A{param.A} F3 R{var.motorLimitsAddr} B3
    var motorCfg = { global.arborRetVal }

    ; 0 = Max Frequency, 1 = Min Frequency
    M261.9 E0 P{param.C} A{param.A} F3 R{var.maximumFrequencyAddr} B1
    var maxFrequency = { global.arborRetVal }
    M261.9 E0 P{param.C} A{param.A} F3 R{var.minimumFrequencyAddr} B1
...
M261.9 E0 P{param.C} A{param.A} F3 R{var.stateBytesAddr} B9
...
if { (var.vfdRunning && !var.vfdForward && !var.vfdReverse) || (!var.vfdRunning && (var.vfdForward || var.vfdReverse)) }
    M260.9 E0 P{param.C} A{param.A} F6 R{var.stateBytesAddr} B{10,}
...
if { !var.shouldRun && var.vfdRunning }
    ...
    M260.9 E0 P{param.C} A{param.A} F6 R{var.setCommandAddr} B{0x0001,}
    ; Set frequency to 0
    M260.9 E0 P{param.C} A{param.A} F6 R{var.setFrequencyAddr} B{0x0000,}
